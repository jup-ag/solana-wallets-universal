...
const WalletDisconnectedGraphic: Component<ComponentProps<"svg">> = _props => {
  const props = mergeProps({ width: "152", height: "125" }, _props)
  return (
    <svg viewBox="0 0 152 125" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
